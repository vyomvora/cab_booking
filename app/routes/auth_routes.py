"""This module defines authentication routes for admin and user"""
import re
...
def admin_login():
    """
    This functino defines admin login
    """
...
def user_login():
    """
    This functino defines user login
    """
...
def user_signup():
    """
    This functino defines user signup
    """
...
def logout():
    """
    This functino defines user logout
    """
    logout_user()
    return redirect(url_for('auth.user_login'))
